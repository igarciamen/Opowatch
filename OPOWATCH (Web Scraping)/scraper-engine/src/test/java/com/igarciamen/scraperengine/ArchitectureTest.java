package com.igarciamen.scraperengine;
...
class ArchitectureTest {
    ...
    private static final JavaClasses CLASSES = new ClassFileImporter()
            ...
            .importPackages("com.igarciamen.scraperengine");
    ...
    @Test
    void controllers_do_not_use_client_directly() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("..controller..")
                .should().dependOnClassesThat().resideInAPackage("..client..");
        rule.check(CLASSES);

        System.out.println("[Arquitectura OK] Ningun controlador depende directamente del cliente HTTP del BOE.");
    }
}